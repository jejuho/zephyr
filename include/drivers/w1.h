...
typedef void  (*w1_read_block_t)(const struct device *dev, uint8_t *buffer,
				 size_t length);

typedef void  (*w1_write_block_t)(const struct device *dev,
 ...
 */
__syscall void w1_lock_bus(const struct device *dev);

static inline void z_impl_w1_lock_bus(const struct device *dev)
{
 ...
 * @param dev  Pointer to the device structure for the driver instance.
 */
__syscall void w1_unlock_bus(const struct device *dev);

static inline void z_impl_w1_unlock_bus(const struct device *dev)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall bool w1_reset_bus(const struct device *dev);

static inline bool z_impl_w1_reset_bus(const struct device *dev)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall bool w1_read_bit(const struct device *dev);

static inline bool z_impl_w1_read_bit(const struct device *dev)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall void w1_write_bit(const struct device *dev, const bool bit);

static inline void z_impl_w1_write_bit(const struct device *dev, bool bit)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall uint8_t w1_read_byte(const struct device *dev);

static inline uint8_t z_impl_w1_read_byte(const struct device *dev)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall void w1_write_byte(const struct device *dev, uint8_t byte);

static inline void z_impl_w1_write_byte(const struct device *dev, uint8_t byte)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall void w1_read_block(const struct device *dev, uint8_t *buffer,
			     size_t length);

static inline void z_impl_w1_read_block(const struct device *dev,
 ...
 */
__syscall void w1_write_block(const struct device *dev, const uint8_t *buffer,
			      size_t length);

static inline void z_impl_w1_write_block(const struct device *dev,
					 const uint8_t *buffer, size_t length)
{
	const struct w1_driver_api *api = dev->api;
 ...
 */
__syscall size_t w1_search_bus(const struct device *dev,
			       uint8_t command,
			       uint8_t family,
 ...
 * @retval              Number of devices found.
 */
static inline size_t w1_search_rom(const struct device *dev,
				  w1_search_callback_t callback_isr,
				  void *callback_arg)
{
 ...
 * @retval              Number of devices found.
 */
static inline size_t w1_search_alarm(const struct device *dev,
				     w1_search_callback_t callback_isr,
				     void *callback_arg)
{
